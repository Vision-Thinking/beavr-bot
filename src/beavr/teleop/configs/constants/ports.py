...
# Dobot CR5 specific ports. Keep these separate from XArm so both adapters can
# be started in the same development environment without ZMQ bind conflicts.
DOBOT_CR5_ENDEFF_PUBLISH_PORT = 10110
DOBOT_CR5_ENDEFF_SUBSCRIBE_PORT = 10109
DOBOT_CR5_RESET_SUBSCRIBE_PORT = 10109
DOBOT_CR5_HOME_SUBSCRIBE_PORT = 10107
DOBOT_CR5_STATE_PUBLISH_PORT = 10116
DOBOT_CR5_TELEOPERATION_STATE_PORT = 8089
